...
import { SerieCardProps } from "@/types/cards"
...
const SerieCard = ({ title, id, active, image, selected }: SerieCardProps) => {
    ...
    const handleDelete = async () => {
        const res = await axios.delete(`/admin/series/delete/${id}`, {
            headers: {
            ...
            <div className="p-3">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex space-x-3">
                        <Popup
                            trigger={open => (
                                <Link href={"/series/" + id} className="h-7 w-7 bg-secondary-900 rounded-full flex items-center justify-center">
