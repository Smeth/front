...
const LiveCard = ({ title, id, active, image, selected }: TVCardProps) => {
    ...
    const handleDelete = async () => {
        try {
            const res = await axios.delete(`/admin/lives/delete/${id}`, {
                headers: {
            ...
            <div className="p-3">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex space-x-3">
                        <Popup
                            trigger={open => (
                                <Link href={"/lives/" + id} className="h-7 w-7 bg-secondary-900 rounded-full flex items-center justify-center">
