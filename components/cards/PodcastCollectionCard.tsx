...
const PodcastCollectionCard = ({ title, id, active, image, selected, handleSelect }: any) => {
    ...
    const handleDelete = async () => {
        try {
            const res = await axios.delete(`/admin/podcast/collections/delete/${id}`, {
                headers: {
    ...
    return (
        <div className="rounded-xl overflow-hidden bg-dark-800 shadow-secondary border border-dark-700">
            <div className="bg-black h-60 w-full relative">
            ...
            <div className="p-3">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex space-x-3">
                        <Popup
                            trigger={open => (
                                <Link href={"/podcasts/collections/" + id} className="h-7 w-7 bg-secondary-900 rounded-full flex items-center justify-center">
