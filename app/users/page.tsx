                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col md:flex-row items-center space-x-4">
                        ...
                        <div className="">
                            <Popup
                                trigger={open => (
                                    <Link href="/users/add" className="flex items-center space-x-2 bg-secondary-900 py-1.5 px-2 rounded">
                                        <PlusIcon classes="h-3.5 text-white" />
                                        <span className="text-white text-sm font-semibold">Ajouter un utilisateur</span>
                                    </Link>
                                )}
                                position="top center"
                                on={['hover', 'focus']}
                        ...
                        {!isLoading && tableRows.length === 0 && (
                            <div className="w-full bg-black py-6">
                                <p className="text-white text-center font-medium p-6">
                                    ...
                                    <Link href="/users/add" className="font-semibold underline text-blue-500">ajoutez-en !</Link>
                                </p>
                            </div>
                        )}
                    ...
                    <div className="px-4 py-3 flex items-center h-full gap-2">
                        {
                            ...
                            actions.map((action: string, i: number) => {
                                if(action === "view") {
                                    ...
                                    return (
                                        <Link key={i} href={`/users/${id}`} className="text-white text-sm font-medium bg-secondary-900 rounded px-2.5 py-1.5">
