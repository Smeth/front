                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col md:flex-row items-center space-x-4">
                        ...
                        <div className="">
                            <Popup
                                trigger={open => (
                                    <Link href="/users/admins/add" className="flex items-center space-x-2 bg-secondary-900 py-1.5 px-2 rounded">
                                        <PlusIcon classes="h-3.5 text-white" />
                                        <span className="text-white text-sm font-semibold">Ajouter un administrateur</span>
                                    </Link>
                                )}
                                position="top center"
                                on={['hover', 'focus']}
                            >
                                <Tooltip title="Ajouter un administrateur" />
                            </Popup>
                        </div>
                    </div>
                    <div className="">
                        <ExcelExport 
                            ...
                            fileName="admins"
                            label="Exporter les administrateurs"
                        />
                    </div>
                </div>
                <div className="my-4">
                        ...
                        {!isLoading && tableRows.length === 0 && (
                            <div className="w-full bg-black py-6">
                                <p className="text-white text-center font-medium p-6">
                                    ...
                                    <Link href="/users/admins/add" className="font-semibold underline text-blue-500">ajoutez-en !</Link>
                                </p>
                            </div>
                        )}
                    ...
                    <div className="px-4 py-3 flex items-center h-full gap-2">
                        {
                            ...
                            actions.map((action: string, i: number) => {
                                if(action === "view") {
                                    return (
                                        <Link key={i} href={`/users/${id}/history`} className="text-white text-sm font-medium bg-primary-900 rounded px-2 py-1">
                                    ...
                                    return (
                                        <Link key={i} href={`/users/admins/${id}`} className="text-white text-sm font-medium bg-secondary-900 rounded px-2.5 py-1.5">
