...
export default function AddMovie() {
                ...
                if(response.status === 200) {
                    for (const item of response.data.Data) {
                        if (item.langues) {
                            ...
                            console.log('actors', item.acteurs)
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const res = await axios.post('/admin/movies/create', data, {
                headers: {
                    Authorization: `Bearer ${session?.token}`
                }
            })
                                    ...
                                    <div className="flex justify-between items-center space-x-4">
                                        ...
                                        <div className="w-full md:w-2/3">
                                            <SelectSearch
                                                ...
                                                isMulti={true}
                                                defaultValue={movie?.acteurList || null}
                                    ...
                                    <div className="flex justify-between items-center space-x-4">
                                        ...
                                        <div className="w-full md:w-2/3">
                                            <SelectSearch
                                                ...
                                                isMulti={true}
                                                defaultValue={movie?.directorList || null}
                                    ...
                                    <div className="flex justify-between items-center space-x-4">
                                        ...
                                        <div className="w-full md:w-2/3">
                                            <SelectSearch
                                                ...
                                                isMulti={true}
                                                defaultValue={movie?.genreList || null}
                                    ...
                                    <div className="flex justify-between items-center space-x-4">
                                        ...
                                        <div className="w-full md:w-2/3">
                                            <SelectSearch
                                                ...
                                                defaultValue={movie?.langue || null}
                                                onChange={handleSelectSearchChange}
                                            />
                                ...
                                <div className="flex flex-col gap-4 mt-4">
                                    ...
                                    <div className="flex justify-between space-x-4">
                                        ...
                                        <div className="flex flex-col space-y-2 w-full md:w-2/3">
                                            ...
                                            />
                                            {errors && errors?.trailerUrl && <span className="text-red-500 text-sm">{errors.budget}</span>}
                                            {movie.trailerUrl && movie.trailerUrl !== "" && (
