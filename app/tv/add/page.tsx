...
export default function AddChanel() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const { name, overview, tvLogo_path, status, tvEmbedCode, accessFree, svr1_url, svr2_url, svr3_url }: any = e.currentTarget
        ...
        try {
            const res = await axios.post('/admin/tv/create', data, {
                headers: {
                    Authorization: `Bearer ${session?.token}`
                }
            })
                                ...
                                <div className="flex justify-between items-center space-x-4">
                                    ...
                                    <div className="flex flex-col space-y-1 w-full md:w-2/3">
                                        <input 
                                            ...
                                            name="name" 
                                            id="name"
                                            placeholder="Nom de la chaine live"
                                            required
